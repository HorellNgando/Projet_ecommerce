<?php
    ...
    $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'shoesfoot'");
    $stmt->execute();
...
<html>
    ...
    <body>
        ...
        <div id="contener" style="margin-top: 5%; ">
            <section style="background-color: #E4E4E4; width:1400px;">
                <h1 style="background-color: #E4E4E4; width: 1200px; padding: 3% 0; padding-left: 7%; margin-top:10px;">CHAUSSURES</h1>
                <div id="shoes">
                <?php
        ...
        <?php
            ...
            $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'equipfoot'");
            $stmt->execute();
            ...
            <div id="contener">
            <section style="background-color: rgba(255, 228, 196, 0.721); width:1400px;">
                <h1 style="background-color: ; width: 1300px; padding: 3% 0; padding-left: 7%; margin-top:10px;">GANTS - BALLONS</h1>
                <div id="ballons">
                <?php
        ...
        $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'maillotfoot'");
        $stmt->execute();
        ...
        <div id="contener">
        <section style="background-color: #aaa9a9e3; width:1400px;">
            <h1 style="text-align:center; width: 1200px; padding: 3% 0; padding-left: 7%; margin-top:10px;">MAILLOTS</h1>
            <div id="maillot">
            <?php
                ...
                <form action="insertion_produit_panier.php" method="post">
                    ...
                    <a href="insertion_produit_panier.php?idproduit=<?php echo $row['idproduit'] ?>"><div class="cadre">
                        <div style="width: 80%; height: 55%; padding: 10px; margin-left: 20px;"><img src="image/<?php echo $row['imageproduit'] ?>" id="sac training nba" alt="text-alternatif" style="height: 100%; width: 100%; object-fit: contain;"></div>
                        <div style="text-align: center;">
                            <p style="font-size: medium; text-transform: uppercase; font-weight: bold;"><a href="#"><?php echo $row['nomproduit'] ?></a></p>
                            <p style="font-size: medium; text-transform: uppercase; font-weight: bold;"><a href="#"><?php echo $row['prixproduit'] ?> fcfa</a></p>
                            <input type="submit" value="Buy now" name="acheter" class="buy">
