<?php
    ...
    $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'basket'");
    $stmt->execute();
...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'ballons'");
            $stmt->execute();
        ...
        <div id="contener">
            <section style="background-color: rgba(255, 228, 196, 0.721); width:1400px;">
                <h1 style="background-color: ; width: 1300px; padding: 3% 0; padding-left: 7%; margin-top:10px;">EQUIPEMENTS - BALLONS</h1>
                <div id="ballons">
                <?php
        ...
        <?php
            ...
            $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'maillot'");
            $stmt->execute();
