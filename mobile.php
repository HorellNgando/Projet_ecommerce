            ...
            <div style="display: flex; justify-content: center;">
                <div id="contenu">
                    <section id="photo">
                        ...
                        <div style="color: black; text-transform: uppercase; text-align: center; display: flex; flex-direction: row; justify-content: space-around; margin-top: 10px;">
                            <h2>Total</h2>
                            <div id="calcul">
                    ...
                    <section id="form">
                        <form action="payement.php" method="post">
                            <div style="display: flex; flex-direction: row; justify-content: space-around;">
                                ...
                                <img src="image/R (7) 1.png" alt="text-alternatif" style="height: 30px; margin-top: 15px; object-fit: contain;" >
                            </div>
                            <div class="inp">
                            ...
                            <div class="code">
                                ...
                                <br><input type="password" id="code" name="code" placeholder="*****">
                            </div>
