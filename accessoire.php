<?php
    ...
    $stmt = $con->prepare("SELECT * FROM produit WHERE categorieproduit = 'accessoire'");
    $stmt->execute();
            ...
            <div id="nav">
                ...
                <div id="icon">
                    ...
                    <!-- <?php
                            ...
                            ?>
                            <p style="background: red; height: 20px; width: 20px; border-radius: 50%; margin-top: 3px; margin-left: -25px; text-align: center; font-size: larger;"><?php echo $nbre_produit; ?></p>
                            <?php  
                                // }
                            ?> -->
